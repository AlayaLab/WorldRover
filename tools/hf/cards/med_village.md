...
pretty_name: WorldRover — med_village
task_categories:
  - depth-estimation
  - robotics
tags:
...
# WorldRover — med_village

Medieval village, outdoor, daylight. **13 clips per view, 32.1 min each of panoramic and first-person video**,
...
| | |
|---|---|
| Clips | 13 per view (26 total) |
| Duration | 32.1 min per view |
| Panoramic | 4096x2048 equirectangular — 29 GB rgb + 242 GB depth |
| First person | 1280x720 pinhole, hfov 65.5 deg — ~16 GB |
...
clip = Clip("/data/WorldRover-med_village/venice/fp/venice_000003")
